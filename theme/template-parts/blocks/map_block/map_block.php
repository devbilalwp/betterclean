...
// Block data.
$block_class_identifier = "block-map";

$map = get_sub_field( 'map' );
?>

<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-tMTaMZqa4hthLji_rcPqL3Sw28frfh8&callback=Function.prototype"></script>
